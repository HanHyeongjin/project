	...
	<form action="reviewinsert" method="post" enctype="multipart/form-data">
		<div class="reviewform">
			...
			<div align="center" style="font-size: 1.1em">
				<span>게임에 대한 리뷰와 평점을 작성해 주세요.<br> 평점 주기를 한번 클릭 후 평점을 줄 수
					있습니다.<br> 평점을 준 후 평점주기를 다시한번 클릭시 평점을 다시 줄 수 있습니다.
				</span><br> <span
					style="color: DarkRed; font-size: 1.3em; font-weight: bold;">
					* 과도한 욕설 및 비방등을 작설할 경우 사이트 이용에 제한이 걸릴 수 있습니다. *</span>
			</div>
			<div class="hrdiv2"></div>
			<div style="display: flex;">
				<div class="titlediv">
					<div class="texttitle">제목</div>
					<input type="text" class="title" name="rtitle" id="rtitle">
				</div>
				<div class="titlediv2">
					<div class="texttitle">
						평점 <span class="resets">평점 주기</span>
					</div>
					<div style="display: flex;">
						<div class="stars">
						...
						<div class="inputstar">
							<input id="display" value="0" size="1" name="score"
								readonly="readonly"> 점
						</div>
					</div>
				</div>
